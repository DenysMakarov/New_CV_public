        ...
        el.addEventListener("click", function () {
            switch (el.id) {
                case 'linkOfGame':
                    ...
                    break;
                case 'linkOfSlider':
                    alert("This is library of MagicSlider whitch had developed by me for 'Codester' market. This link from www.codester.com where library is selling now. This slider works as a library. You can connect it in your personal code where you want. Instructions included into folder 'LIBRARY' of Git link");
